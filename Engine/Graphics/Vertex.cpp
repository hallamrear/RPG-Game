...
void Vertex::GetElementDescription(std::vector<D3D12_INPUT_ELEMENT_DESC>& vectorToFill)
{
	...
	vectorToFill.push_back({ "TEXCOORDS", 0, DXGI_FORMAT_R32G32_FLOAT, 0, offsetof(Vertex, UV), D3D12_INPUT_CLASSIFICATION::D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 });
}